...
public class OldPersistedMetadata<T> implements Comparable<OldPersistedMetadata<T>> {
    ...
    @Override
    public int compareTo(OldPersistedMetadata other) {

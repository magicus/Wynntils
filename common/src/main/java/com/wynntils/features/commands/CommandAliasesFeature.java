...
public class CommandAliasesFeature extends Feature {
    ...
    public final HiddenConfig<List<CommandAlias>> aliases = new HiddenConfig<>(new ArrayList<>(List.of(
            new CommandAlias("guild attack", List.of("guild a")),
            new CommandAlias("guild manage", List.of("guild m", "guild man")),
            new CommandAlias("guild territory", List.of("guild t", "guild terr")))));

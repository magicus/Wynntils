...
public class QuestInfoParser {
    ...
    protected static QuestInfo parseItem(ItemStack item, int pageNumber, QuestType type) {
        try {
            ...
            Quest quest = new Quest(name, level, type, questLength, additionalRequirements);
